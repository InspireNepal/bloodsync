...
import Sprint4Image from '../assets/Sprint4 Image1.jpg';
...
const Project = () => {
  ...
  const blogs4 = [
    {
      title: "Making a Difference in Rukum",
      image: Sprint4Image,
      text: "  Our team was eagerly anticipating the long-awaited opportunity to connect withour communitypartner this sprint. Previous attempts to establish contact hadbeen hindered by variouscircumstances, but this week held the promise of abreakthrough. Our anticipation culminated in in a meaningful meeting with the Administrator of Chaurajhari Hospital. During our meeting, we were profoundly moved by the realization of just how essential along..."
    }
  ];
                  ...
                  <div className="flex flex-col md:flex-row w-full gap-10">
                    ...
                    <Link to="blog3">
                      ...
                      <p className="text-lg md:text-xl font-medium md:leading-12 text-center tracking-wide text-[#3B536D]">
                        ...
                        <div className="w-full text-left">
                          {oneBlog.text} <span className="text-blue-500">Read More..</span>
                        </div>
                      </div>
                    </Link>
                  </div>
